...
class GRU4RecModel(SequentialBaseModel):
    ...
    def _build_seq_graph(self):
        ...
        with tf.variable_scope("gru4rec"):
            ...
            final_state, rnn_outputs = self._build_gru()
            # self.hist_embedding_mean = tf.reduce_sum(rnn_outputs*tf.expand_dims(self.real_mask, -1), 1)/tf.reduce_sum(self.real_mask, 1, keepdims=True)
